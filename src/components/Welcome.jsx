...
export default function Welcome() {
  ...
  return (
    <div className="w-screen h-screen flex justify-center items-center p-8 md:p-0 bg-gradient-to-t from-purple-600 to-violet-600 text-white">
      <div className="flex flex-col items-center justify-center w-full h-full md:size-1/2 border-4 border-purple-300/50 rounded-md">
        <h1 className="w-full text-center text-2xl">
          React Test Suite
        </h1>

        <div className="flex flex-col items-center justify-center h-2/3 w-full px-4">
          <div className="w-full flex flex-col items-center justify-center h-full space-y-14">
